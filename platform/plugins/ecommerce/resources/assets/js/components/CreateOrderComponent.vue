<template>
    <div class="flexbox-grid no-pd-none">
                    ...
                    <div class="next-card-section p-none-b">
                        <div class="flexbox-grid-default">
                            ...
                            <div class="flexbox-auto-left">
                                <a href="#" data-toggle="tooltip" data-placement="top" title="Delete customer"
        ...
        <b-modal id="make-paid" :title="__('order.Create a new order')" :ok-title="__('order.create_order')" :cancel-title="__('order.close')"
